...
%>
  <div id="main">
    ...
    <div id="site_content">
      <div id="banner"><img src="image/aboutus.jpg" alt="image" style="width:860px;height:180px;"></div>
  ...
  <p style="font-size:140%;">
		 ...
		 The <b>PFS</b> is at the cutting edge of the nation's technological progress and achievement.
		<br><br>
		<h2><u>THE DEVELOPERS</u></h2>
		<p style="font-size:140%;"> 
		<b>SREERADHA SEN SARMA:</b> A 4th year CSE student from F.I.E.M.,Kolkata. She's the leader... 
		</p><br>
		<hr><br>
		<p style="font-size:140%;"> 
		<b>PRITAM GUHA:</b> A 4th year CSE student from F.I.E.M.,Kolkata. He's the asst. leader... 
		</p><br>
		<hr><br>
		<p style="font-size:140%;"> 
		<b>PALLAVI DATTA:</b> A 4th year CSE student from F.I.E.M.,Kolkata.She's the design head... 
		</p><br>
		<hr><br>
		<p style="font-size:140%;"> 
		<b>KOUSTAV CHAKRABORTY:</b> A 4th year CSE student from F.I.E.M.,Kolkata. He's the asst. design head... 
		</p><br>
		<hr><br>
		<p style="font-size:140%;"> 
		<b>ALINA GHOSH:</b> A 4th year CSE student from F.I.E.M.,Kolkata.She's the resource head... 
		</p><br>
		<hr><br>
  </p>
    ...
    <div id="footer">
      ...
      <p>Copyright &copy; PFS 2017 | Pritam Guha | Pallavi Datta | Koustav Chakraborty | Sreeradha Sen Sarma | Alina Ghosh </p>    </div>
  </div>
</body>
</html>
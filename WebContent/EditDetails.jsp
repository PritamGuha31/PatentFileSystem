...
<%@page import="com.pfs.utils.ClientUtils"%>
      ...
      <div id="content">
        ...
        <form action="update_request" method="POST">
         ...
         <div class="form_settings">
            <p><span>Name: </span><input type="text" name="cname" value="<%= client.getCname() %>" ></p>
            <p><span>Email: </span><input class="contact" type="email" name="cemail" value="<%= client.getCemail() %>" /></p>
            <p><span>Password: </span><input class="contact" type="password" name="cpass" value="<%= client.getCpass() %>" /></p>
            <p><span>Address: </span><textarea class="contact textarea" rows="4" cols="50" name="caddress"><%= client.getCaddress() %></textarea></p>
            <p><span>Phone: </span><input class="contact" type="number" name="cphone" value="<%= client.getCphone() %>" /></p>
            <p><span>Aadhaar Number: </span><input class="contact" type="number" name="caadhar" value="<%= client.getCaadhar() %>" /></p>
            <p><span>DOB: </span><input class="contact" type="text" name="cdob" value="<%= client.getDob() %>" /></p>

...
<%
	...
	List<Examiner> examiner=(ArrayList<Examiner>)session1.getAttribute("examinerList");
%>
  <div id="main">
    <div id="header">
      <div id="logo">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="examinerServlet">Examiners</a></li>
      ...
      <div id="content">
        ...
        <ul>
            <%
              ...
              %>
              <p> <label><b>NAME:</b></label> <label for="ename"><%=  e.getEname() %></label> </p>
  				<p> <label><b>DESIGNATION:</b></label> <label for="erole"><%=e.getErole() %></label> </p>
 				 <p> <label><b>EMAIL:</b></label> <label for="email"></label> <%=e.getEmail() %></p>
        <hr>
        <br> <br>
              <%
              	}

...
<%
	...
	rlist= eu.getAllRequests();
	
	HttpSession session1=request.getSession(false);
	List<Request> req=(ArrayList<Request>)session1.getAttribute("reqList");
%>
  <div id="main">
    <div id="header">
      <div id="logo">
      ...
      <div id="content">
        ...
        <ul>
            <%
              ...
              %>
              <p> <label><b>APPLICANT NAME:</b></label> <label for="cname"><%=r.getClient().getCname() %></label> </p>
  				<p> <label><b>PATENT DESCRIPTION:</b></label> <label for="rdesc"><%=r.getRdesc() %></label> </p>
 				 <p> <label><b>PATENT DATE:</b></label> <label for="rdate"></label> <%=r.getRdate() %></p>
        <hr>
        <br> <br>
              <%
              	}

...
%>
  <div id="main">
    ...
    <div id="site_content">
      <div id="banner">
      <img src="image/home.jpg" alt="image" style="width:860px;height:180px;"></div>
      ...
      <div id="content">
        ...
        <div class="form_settings">
            <p><span>Name: </span><input class="contact" type="text" name="cname" value="" required/></p>
            ...
            <p><span>Phone: </span><input class="contact" type="number" name="cphone" value="" required/></p>

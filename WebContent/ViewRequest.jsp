...
<%
	...
	List<Request> requestList= (List<Request>)session.getAttribute("reqList");
	
	List<Request> rList = new ArrayList<Request>();
	CommonUtils cu=new CommonUtils();
	rList = cu.getAllApprovedRequests();
	Request req = (Request)session.getAttribute("r");
...
%>
    ...
    <div id="header">
      <div id="logo">
        <div id="logo_text">
          ...
          <h1><a href="index.html">PATENT <span class="logo_colour">FILE SYSTEM</span></a></h1>
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li><a href="page.html">Examiners</a></li>
          <li><a href="another_page.html">Patents</a></li>
 ...
 <h4>ALL REQUEST DETAILS OF CLIENT</h4>
  ...
  <tr>
	...
	<td> <%=r.getRid()%> </td> <td> <%=r.getRdesc()  %></td> <td> <%=r.getRdate()%>  </td> <td> <%=r.getRstatus()%>  </td>
	 </tr>	
	<%
			}
		}
